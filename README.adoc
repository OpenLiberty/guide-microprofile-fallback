...
:page-seo-title: Building fault-tolerant microservices with the MicroProfile Fault Tolerance @Fallback annotation
:page-seo-description: A tutorial and an example on how to use MicroProfile Fault Tolerance to build resilient microservices and obtain metrics from the Fault Tolerance methods with MicroProfile Metrics.
