...
the dependency with the `mpFaultTolerance` artifact ID. Adding this dependency allows you to use the 
fault tolerance policies in your microservices.

You can also find the [hotspot=9 file=3]`mpFaultTolerance` feature in your [hotspot=1-15 file=3]`server.xml` server configuration,
