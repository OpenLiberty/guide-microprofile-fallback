...
the dependency with the [hotspot=mpFaultTolerance file=4]`mpFaultTolerance` artifact ID. Adding this dependency allows you to use the
...
the [hotspot=isInMaintenance file=0]`isInMaintenance()` condition, which determines that the system properties are returned only if you
...
SystemResource.java
[source, java, linenums, role='code_column hide_tags=503_response']
----
...
SystemClient.java
[source, java, linenums, role='code_column hide_tags=client']
----
...
[source, java, linenums, role='code_column hide_tags=add_fallback']
----
...
The [hotspot=Before]`@Before` and [hotspot=After]`@After` annotations indicate that this method executes before or after the other test case.
...
[source, java, linenums, role='code_column hide_tags=ft_testing, javadoc']
----
include::finish/src/test/java/it/io/openliberty/guides/faulttolerance/FaultToleranceTest.java[]
----
// =================================================================================================
// Running the tests
// =================================================================================================
...
You see a test failure occur for the [hotspot=testFallbackForGet]`testFallbackForGet()` test case.
