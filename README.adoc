...
First, the [hotspot=1-27 file=0]`src/main/java/io/openliberty/guides/system/SystemResource.java` class has
...
Next, the [hotspot=1-25 file=2]`src/main/java/io/openliberty/guides/inventory/client/SystemClient.java` class
