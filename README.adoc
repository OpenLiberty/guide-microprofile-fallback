...
a failed execution. You will also learn how to view metrics for any method or class annotated with
...
Next, return back to the `https://localhost/metrics/application` URL. The
...
* The `ft_io_openliberty_guides_inventory_inventory_manager_get_fallback_calls_total` metrics counts
