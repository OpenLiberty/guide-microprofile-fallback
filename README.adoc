...
You will learn how to use MicroProfile Fault Tolerance to build resilient microservices
...
file to enables MicroProfile Fault Tolerance support in Open Liberty
...
the properties. The `fallbackForGet()` method is being called when the `system` service is not available.
