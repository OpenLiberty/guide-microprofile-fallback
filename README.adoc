...
You can learn more about MicroProfile Metrics in the https://openliberty.io/guides/microprofile-metrics.html[Providing metrics from a microservice^] guide. You can also learn more about the MicroProfile Fault Tolerance and Metrics integration in the MicroProfile Fault Tolerance https://github.com/eclipse/microprofile-fault-tolerance/releases[specification documentation^].
