...
the dependency with the [hotspot=110-115 file=4]`mpFaultTolerance` artifact ID. Adding this dependency allows you to use the 
...
First, the [hotspot=1-27 file=0]`SystemResource` class has
...
Next, the [hotspot=1-25 file=2]`SystemClient` class
