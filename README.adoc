...
:page-seo-title: Building fault-tolerant microservices with Eclipse MicroProfile Fault Tolerance's Fallback policy
:page-seo-description: A tutorial on how to build resilient Java microservices that deal with failed executions and monitor the fault tolerance methods using MicroProfile Fault Tolerance and MicroProfile Metrics.
