...
You can also find the [hotspot=mpFaultTolerance file=3]`mpFaultTolerance` feature in your [hotspot file=3]`src/main/liberty/config/server.xml` Liberty configuration file, which turns on MicroProfile Fault Tolerance capabilities in Open Liberty.
