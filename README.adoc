...
likely be alleviated after some delay. To simulate that the system is unavailable, an [hotspot=24 file=2]`IOException` is thrown.

The public [hotspot=23-25 file=2]`getProperties()` method in this class calls the `getPropertiesHelper()` method.
