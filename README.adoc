...
The MicroProfile Fault Tolerance API is included in the MicroProfile dependency specified by your [hotspot file=0]`pom.xml` file. 
...
in the [hotspot]`FaultToleranceIT.java` file. Rerun the tests to see a test failure occur for the [hotspot=34-53]`testFallbackForGet()` test case.
